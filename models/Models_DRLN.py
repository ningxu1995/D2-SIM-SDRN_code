...
class DRLN(nn.Module):
    def __init__(self, opt):
        ...
        self.head = nn.Conv2d(opt.nch_in, chs, 3, 1, 1)

        self.b1 = Block(chs, chs, reduction)
        self.b2 = Block(chs, chs, reduction)
        self.b3 = Block(chs, chs, reduction)
        self.b4 = Block(chs, chs, reduction)
        self.b5 = Block(chs, chs, reduction)
        self.b6 = Block(chs, chs, reduction)
        self.b7 = Block(chs, chs, reduction)
        self.b8 = Block(chs, chs, reduction)
        self.b9 = Block(chs, chs, reduction)
        self.b10 = Block(chs, chs, reduction)
        self.b11 = Block(chs, chs, reduction)
        self.b12 = Block(chs, chs, reduction)
        self.b13 = Block(chs, chs, reduction)
        self.b14 = Block(chs, chs, reduction)
        self.b15 = Block(chs, chs, reduction)
        self.b16 = Block(chs, chs, reduction)
        self.b17 = Block(chs, chs, reduction)
        self.b18 = Block(chs, chs, reduction)
        self.b19 = Block(chs, chs, reduction)
        self.b20 = Block(chs, chs, reduction)
        ...
        self.tail = nn.Conv2d(chs, opt.nch_out, 3, 1, 1)
